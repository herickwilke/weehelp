        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.prioridadeChamado.title_singular') }}
                </div>
                <div class="panel-body">

                    <form action="{{ route("admin.prioridade-chamados.update", [$prioridadeChamado->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
