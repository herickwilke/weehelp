        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.statusChamado.title_singular') }}
                </div>
                <div class="panel-body">

                    <form action="{{ route("admin.status-chamados.update", [$statusChamado->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
