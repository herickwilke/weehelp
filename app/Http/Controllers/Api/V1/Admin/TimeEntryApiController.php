...
class TimeEntryApiController extends Controller
{
    public function index()
    {
        ...
        return new TimeEntryResource(TimeEntry::with(['work_type', 'project', 'chamado', 'status', 'usuario'])->get());
    }
    ...
    public function show(TimeEntry $timeEntry)
    {
        ...
        return new TimeEntryResource($timeEntry->load(['work_type', 'project', 'chamado', 'status', 'usuario']));
    }
